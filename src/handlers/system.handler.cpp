...
void handleSystemEvent(const String &setting, const String &value, AsyncWebSocketClient *client) {
	if (setting == "get" && value == "version") {
		sendResponse(client, "system", "get", "success", SYSTEM_VERSION, "");
		// // TODO: aktuell startet esp neu wenn url nicht aufgelöst werden kann- fehlerbehandlung und log ausgabe
