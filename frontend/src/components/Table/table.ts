...
import TableHead from "./Head/tableHead.vue";
import TableBody from "./Body/tableBody.vue";
import TableFooter from "./Footer/tableFooter.vue";
...
export default defineComponent({
	...
	emits: {
		...
		onTableParamsChanged: (p: TableParams) => typeof p.page === "number" && typeof p.size === "number",
	},
	setup(props, { emit }) {
